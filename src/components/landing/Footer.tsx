const Footer = () => (
  <footer className="relative border-t border-primary-foreground/10 py-10 bg-surface-frame">
    <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary-foreground/40 to-transparent" />
